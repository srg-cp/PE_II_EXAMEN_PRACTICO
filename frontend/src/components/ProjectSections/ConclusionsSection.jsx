...
const ConclusionsSection = ({ projectId, sectionData, onDataUpdate, user, project }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await axios.put(`/api/projects/${projectId}/sections/conclusions`, {
        content,
        userId: user._id
      });
      ...
      setError(error.response?.data?.message || 'Error al guardar las conclusiones');
    } finally {
      setSaving(false);
    }
  };
    ...
    <Box>
      ...
      <Box sx={{ minHeight: 400 }}>
        <ReactQuill
          ...
          theme="snow"
          placeholder="Escribe las conclusiones del proyecto aquí..."
          style={{
